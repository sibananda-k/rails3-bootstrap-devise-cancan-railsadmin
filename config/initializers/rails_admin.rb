# RailsAdmin config file. Generated on November 27, 2012 17:26
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Catagory', 'Product', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Catagory', 'Product', 'Role', 'User']
  ...
  #     configure :sku, :integer 
  #     configure :catagory_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
